...
export default function ActivityLogModal({ isOpen, onClose, history = [], onClearHistory }) {
  ...
  return (
    ...
    >
      <div
        className="bg-slate-900/95 border-2 border-emerald-500/40 p-6 sm:p-8 rounded-3xl shadow-2xl max-w-xl w-full flex flex-col space-y-5 transform animate-in zoom-in-95 duration-200 max-h-[85vh] overflow-hidden"
      ...
      >
        ...
        <div className="flex items-center justify-between border-b border-slate-800 pb-4">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">Real-time log stream of confirmed gesture triggers</p>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-2">
            ...
            {onClearHistory && history.length > 0 && (
              <button
                ...
                className="p-2 rounded-xl bg-rose-500/10 border border-rose-500/30 hover:bg-rose-500/20 text-rose-400 transition"
        ...
        {/* Terminal Logs List */}
        <div className="flex-1 overflow-y-auto space-y-2.5 pr-1 font-mono text-xs custom-scrollbar max-h-[380px]">
          {history.length === 0 ? (
